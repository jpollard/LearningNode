...
{
    // any folder under 'albums' is a subfolder
...
function load_album(album_name, page, page_num, callback)
{
    fs.readdir(
        "albums/" + album_name,
        function (err, files) {
...
function send_failures(res, code, err) {
